...
public class APIRequestTask implements Runnable {
	...
	private static final String apiServicesAddress = "https://api.mediatemple.net/api/v1/services/";
   	...
   	/*
   	 * Flush the firewall rules of a server
   	 */
   	...
   	/*
   	 * Get the stats for the last 15 minutes of a server
   	 */
   	...
   	/*
   	 * Get the stats for the last hour from a server
   	 */
   	...
   	/*
   	 * Change the root password of a server
   	 */
   	...
   	/*
   	 * Change the Plesk password of a server
   	 */
   	 ...
   	 * 
   	 * @return JSONArray containing the result of the request
   	 */
